...
_typeAI = "typeAI" call BIS_fnc_getParamValue;
...
if (_faction==2) then {
	switch (_typeAI) do {
		case 0: {
			...
			_MotPool=	["I_MRAP_03_F","I_MRAP_03_gmg_F","I_MRAP_03_hmg_F","I_Truck_02_medical_F","I_Truck_02_ammo_F","I_Truck_02_fuel_F","I_Truck_02_box_F","I_Truck_02_covered_F","I_Truck_02_transport_F"];
			_ACHPool=	["I_Heli_light_03_F","I_Plane_Fighter_03_CAS_F"];
			...
			_stPool=	["I_HMG_01_high_F","I_GMG_01_high_F","I_Mortar_01_F","I_static_AA_F","I_static_AT_F","I_HMG_01_F","I_HMG_01_A_F","I_GMG_01_F","I_GMG_01_A_F"];
			_shipPool=	["I_Boat_Transport_01_F","I_G_Boat_Transport_01_F","I_Boat_Armed_01_minigun_F"];
			_diverPool=	["I_diver_exp_F","I_diver_F","I_diver_TL_F","i_g_soldier_unarmed_f"];
			_crewPool=	["I_crew_F"];
		...
		case 1: {
			...
			_MotPool=	["I_C_Offroad_02_unarmed_F","I_C_Van_01_transport_F","I_G_Offroad_01_F","I_G_Offroad_01_armed_F","I_G_Offroad_01_repair_F","I_G_Van_01_transport_F","I_Truck_02_transport_F"];
			_ACHPool=	["I_Heli_light_03_F","I_C_Plane_Civil_01_F"];
			_CHPool=	["I_C_Heli_Light_01_civil_F","I_Heli_Transport_02_F","I_Heli_light_03_unarmed_F"];
			_uavPool=	["I_UAV_01_F"];
			_stPool=	["I_G_Mortar_01_F","I_HMG_01_high_F","I_GMG_01_high_F","I_Mortar_01_F","I_static_AA_F","I_static_AT_F"];
			...
			_crewPool=	[/*"I_C_Soldier_Camo_F",*/"I_C_Soldier_Bandit_7_F","I_C_Soldier_Bandit_6_F"];
...
//if (isClass(configFile >> "CfgPatches" >> "rhs?")) then { \/* ACE is available *\/ } else { \/* ACE is NOT available *\/ };
// ADD CLASSNAMES 
	if (_faction==5) then {
	_InfPool=	[];	
	_ArmPool=	[];
