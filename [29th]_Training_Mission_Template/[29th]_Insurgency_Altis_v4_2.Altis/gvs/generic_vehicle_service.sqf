...
_per_fuel_time = if (count _this > 6) then { _this select 6 } else { 2 }; //default 2
_per_repair_time = if (count _this > 7) then { _this select 7 } else { 6 }; //default 6
_per_magazine_time = if (count _this > 8) then { _this select 8 } else { 8 }; //default 8
