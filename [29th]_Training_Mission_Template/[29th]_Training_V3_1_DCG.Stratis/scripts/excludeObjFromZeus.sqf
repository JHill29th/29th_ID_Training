...
curatorExcludedObjects = [] spawn {
	...
	_ex_zeus_modules = [zeus_admin,zeus_co,zeus_snco,zeus_cs,zeus_plt1_pl,zeus_plt1_ps,/*zeus_plt1_s1sl,zeus_plt1_s1asl,zeus_plt1_s2sl,zeus_plt1_s2asl,zeus_plt1_s3sl,zeus_plt1_s3asl,*/zeus_plt2_pl,zeus_plt2_ps/*,zeus_plt2_s1sl,zeus_plt2_s1asl,zeus_plt2_s2sl,zeus_plt2_s2asl,zeus_plt2_s3sl,zeus_plt2_s3asl*/];
	_excluded = [];
	_excluded = (_excluded + (_ex_zeus_modules + (_ex_RespawnPos + (_ex_AmmoBoxes + (_ex_SpectateTerminal + (_ex_Garbage + _ex_BaseLights))))));
	_editableObjects = [];
	while {true} do {
		{
