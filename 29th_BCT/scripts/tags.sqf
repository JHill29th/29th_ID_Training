...
if (isDedicated) exitWith {};
	...
	private ["_weaponsplayer","_name","_nameString","_weaponsplayername","_weaponspic"];
   ...
   // PLAYER NAME CHECK AND DISPLAY
	...
	// PRINT THE RANK/NAME/WEAPON ONSCREEN
					if (count _weaponsplayer != 0) then {	
						...
						_nameString = format [/*"<t size='0.5' color='#f0e68c'>%4. </t>*/"<t size='0.5' color='#f0e68c'>%1</t><br/>",_name/*,_rank*/];
						[_nameString,0.5,0.9,_refresh,0,0,3] spawn bis_fnc_dynamicText;
					};
